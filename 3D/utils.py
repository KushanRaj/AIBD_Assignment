...
def add_args(parser):
    ...
    parser.add_argument("--hid_dims", type=str, default="32,64,64", help="Hidden Dimensions")
    parser.add_argument("--n_levels", type=int, default=2, help="Num levels per bottleneck")
    parser.add_argument(
